...
library SimpleSerialize {
	...
	function sszBeaconBlockHeader(IExecutor.BeaconBlockHeader memory header) internal pure returns (bytes32) {
    ...
    function computeSigningRoot(IExecutor.BeaconBlockHeader memory header, bytes4 forkVersion, bytes32 genesisValidatorsRoot)
	internal pure returns (bytes32) {
